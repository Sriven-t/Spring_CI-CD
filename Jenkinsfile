pipeline {
  ...
  environment {
    ...
    NEXUS_URL   = 'http://35.180.58.44/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://35.180.58.44:8081/repository/maven-snapshots/'
    }
  }
}
  }
